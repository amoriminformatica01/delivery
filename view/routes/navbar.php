...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="./view/img/logoBatatasDaVanda.png" height="60" width="140"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#logarusuario">Entre</button>
                    <button class="btn btn-outline btn-link" data-bs-toggle="modal" data-bs-target="#cadastrausuario">Cadastre-se</button>
