...
class ControllerCardapio
{
    public static function getControllerCardapio()
    {
        ...
        for ($i = 0; $i < count($listaCardapio); $i++) {
            ...
            echo "<img class='border border-success  border-5  text-center'. src=" . "./view/img/" . (utf8_encode($listaCardapio[$i]['imagem'])) . " height=" . "200px" . "  " . "width=" . "200px" . ">";
            ...
            echo "<button class='btn btn-success' data-bs-toggle='modal' data-bs-target='#produto' data-bs-id='$listaCardapio[$i]['id']'.data-bs-item='$listaCardapio[$i]['ITEM']'.data-bs-imagem='../view/img/'.$listaCardapio[$i]['imagem']'.data-bs-preco='$listaCardapio[$i]['preco']'>" . "Adicionar ao carrinho" . "</button>";
            echo "</div>";
        }
        echo '</div>';
        echo '</div>';
